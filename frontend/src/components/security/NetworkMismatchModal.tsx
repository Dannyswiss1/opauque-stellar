  ...
  return (
    ...
    >
      <div className="bg-white text-gray-900 rounded-lg p-6 max-w-md w-full shadow-2xl text-center">
        ...
        <div className="bg-black p-4 rounded mb-6 text-left">
          <p><strong>Expected Network:</strong> <span className="uppercase text-neutral-500">{expectedNetwork}</span></p>
          <p><strong>Wallet Network:</strong> <span className="uppercase text-neutral-500">{actualNetwork || "Unknown"}</span></p>
        </div>
        ...
        <button
          ...
          className="w-full py-2 bg-neutral-600 text-white rounded font-bold hover:bg-neutral-700 transition-colors"
        >
          Retry Connection
        </button>
      </div>
